<?php
    ...
    use function ReflectionPayload\Arr\arrFirstEl;
    use function ReflectionPayload\Arr\arrFirstKey;
    use function ReflectionPayload\Arr\arrWrap;
    use function ReflectionPayload\Arr\arrPullByValueReturnKey;
    ...
    class ReflectionPayload
    {
        ...
        public function __construct($target, $original_payload)
        {
            ...
            $this->target = $target;
            $this->original_payload = arrWrap($original_payload);
        ...
        public function build() : array
        {
            ...
            while (($param = arrFirstEl($copy))->hasType()) {
        ...
        private function buildNameAndValue(array $payload_type_and_value, array &$constructor_name_and_type) : array
        {
            ...
            $payload_type = arrFirstKey($payload_type_and_value);
